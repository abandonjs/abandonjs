 ...
 * @lastUpdate 3.3.0
 */
export function maxSort<T = ObjectType>(list: T[], sortIndex?: string | number) {
 ...
 * @lastUpdate 3.3.0
 */
export function minSort<T = ObjectType>(list: T[], sortIndex?: string | number) {
	const handler = (before: T, after: T) => {
